...
func (r *Repository) GetGrowthRequestByID(id int) (ds.GrowthRequest, []ds.DataGrowthFactor, []float64, error) {
...
func (r *Repository) GetAllDataGrowthFactors() ([]ds.DataGrowthFactor, error) {
...
func (r *Repository) GetDataGrowthFactorByID(id int) (*ds.DataGrowthFactor, error) {
...
func (r *Repository) AddDataGrowthFactor(dataGrowthFactorID uint) error {
	creatorID := 1 
	moderatorID := 2
...
// func (r *Repository) DeleteDataGrowthFactor(dataGrowthFactorID uint) error {
